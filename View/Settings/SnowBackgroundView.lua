...
local function SnowBackgroundViewFunction()
    ...
    for i, color in ipairs(UI.Background.LightColors) do
        Buttons.ColorHex(L("settings.snow.lights.colors.index.label") .. " " .. i, UI.Background.LightColors, i, tip("settings.snow.lights.colors.index.tip"))
    end
end
